...
import com.example.smartani.Activities.Fragments.HomeFragment;
import com.example.smartani.Activities.Fragments.ProfilFragment;
import com.example.smartani.Activities.Fragments.SettingFragment;
...
implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home,  R.id.nav_setting, R.id.nav_profil,R.id.nav_logout)
